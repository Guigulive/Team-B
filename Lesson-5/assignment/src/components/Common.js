...
class Common extends Component {
    ...
    componentDidMount() {
        ...
        this.NewEmployee = payroll.NewEmployee(this.checkInfo)
        this.UpdateEmployee = payroll.UpdateEmployee(this.checkInfo)
        this.RemoveEmployee = payroll.RemoveEmployee(this.checkInfo)
        this.NewFund = payroll.NewFund(this.checkInfo)
        this.GetPaid = payroll.GetPaid(this.checkInfo)
