...
class App extends Component {
  ...
  // onSelectAccount = (ev) => {
  //   this.setState({
  //     selectAccount: ev.target.text
  //   })
  // }

  // render() {

  //   const {selectAccount, accounts, payroll, web3} = this.state;
  ...
  //             {
  //               selectAccount === accounts[0]?
  //               <Employer employer={selectAccount} payroll={payroll} web3={web3} />:
  //               <Employee employee={selectAccount} payroll={payroll} web3={web3} />
  //             }
  //             {payroll && <Common account={selectAccount} payroll={payroll} web3={web3} />}
  //           </div>
  //         </div>
  //       </main>
  //     </div>
